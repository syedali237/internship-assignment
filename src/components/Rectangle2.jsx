...
function Rectangle2() {
  return (
    <div className="bg-[#FFFFFF] w-full h-[600px]" data-aos="zoom-in">
    <div className='pt-[80px] pl-[100px] pr-[85px]'>

      <div className="grid grid-cols-[407px_1fr] gap-x-[180px] mb-[30px]">

        <div className="bg-[#EEEEEE99] h-[420px] rounded-[10px]" data-aos="slide-right"></div>

        <div className="h-[426px]">
          <h2 className="font-jakarta text-[36px] font-bold leading-[45.36px] tracking-[0.02em] text-left text-[#0B2C4B] mb-[45px]" data-aos="slide-left">
            Expert Consultation
          </h2>
          <p className="font-jakarta font-medium text-[20px] leading-[35px] text-[#263238] mb-[46px]" data-aos="slide-left">
          ...
          <ul className="flex flex-col font-jakarta font-normal text-[18px] text-center leading-[32px] text-[#455A64] space-y-[25px] mb-[40px]">
            <li className="flex items-center space-x-[20px]" data-aos="slide-left">
              <span>
          ...
          <button data-aos="slide-left" className="bg-[#1B72B1] w-[166px] h-[52px] rounded-[5px] text-[#FFFFFF] font-poppins font-normal text-[18px] leading-[30px] tracking-[0.02em]">
            Learn More
          </button>
        </div>
      </div>
